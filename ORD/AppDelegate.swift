...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func makeRoot()
    {
        ...
        if !hasLaunchedBefore {
            ...
            let VC = mainStoryboard.instantiateViewController(withIdentifier: "initialVC") as! PopUpVC
        ...
        {
            let mainStoryboard = UIStoryboard(name: "Main", bundle: nil)
            let VC = mainStoryboard.instantiateViewController(withIdentifier: "mainScreen") as! ViewController
            let centerNavVC = UINavigationController(rootViewController: VC)
            self.window = UIWindow(frame: UIScreen.main.bounds)
            self.window?.rootViewController = centerNavVC
            self.window?.makeKeyAndVisible()
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "ORD")
